...
const sampleQuestions = [
  {
    ...
    options: [
      { text: "Paris", correct: true, id: optionIds.q1.a },
      { text: "London", correct: false, id: optionIds.q1.b },
      { text: "Berlin", correct: false, id: optionIds.q1.c },
      { text: "Madrid", correct: false, id: optionIds.q1.d },
    ],
    id: questionIds.q1,
  },
  {
    ...
    options: [
      { text: "Jupiter", correct: true, id: optionIds.q2.a },
      { text: "Saturn", correct: false, id: optionIds.q2.b },
      { text: "Earth", correct: false, id: optionIds.q2.c },
      { text: "Mars", correct: false, id: optionIds.q2.d },
    ],
    id: questionIds.q2,
  },
  {
    ...
    options: [
      { text: "H2O", correct: true, id: optionIds.q3.a },
      { text: "O2", correct: false, id: optionIds.q3.b },
      { text: "CO2", correct: false, id: optionIds.q3.c },
      { text: "H2", correct: false, id: optionIds.q3.d },
    ],
    id: questionIds.q3,
  },
  {
    ...
    options: [
      { text: "William Shakespeare", correct: true, id: optionIds.q4.a },
      { text: "Charles Dickens", correct: false, id: optionIds.q4.b },
      { text: "Jane Austen", correct: false, id: optionIds.q4.c },
      { text: "Mark Twain", correct: false, id: optionIds.q4.d },
    ],
    id: questionIds.q4,
  },
  {
