    ...
    >
      ...
      {LeftIcon && (
        <div
          ...
          className={cn(
            "pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 peer-focus:text-primary",
            {
      ...
      {RightIcon && (
        <div
          ...
          className={cn(
            "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 peer-focus:text-primary",
            {
              "!text-feedback-error": error,
            },
          )}
