...
const RetentionRate = ({ completed, outOfTime, quit }: RetentionRateProps) => {
  return (
    <div className="h-full space-y-4 rounded-lg border border-secondary-shadow bg-secondary-tint p-8">
      ...
      <div className="divide-x-sm flex w-full divide-black border border-black">
        {completed > 0 && (
          <div
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <div className="h-4 w-8 border border-black bg-feedback-success" />
          <Smoll>Completed ({completed}%)</Smoll>
        </div>
        <div className="flex items-center gap-2">
          <div className="h-4 w-8 border border-black bg-feedback-warning" />
          <Smoll>Out of Time ({outOfTime}%)</Smoll>
        </div>
        <div className="flex items-center gap-2">
          <div className="h-4 w-8 border border-black bg-feedback-error" />
