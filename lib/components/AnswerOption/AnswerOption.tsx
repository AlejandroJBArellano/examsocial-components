...
const AnswerOption = ({
  ...
  return (
    <button
      className={
        "w-full rounded-lg border border-black px-4 py-3 text-start text-xl leading-6 tracking-[0.4px] hover:shadow-right-sm hover:shadow-black xl:px-5 xl:py-4 xl:text-2xl xl:leading-7 xl:tracking-[0.48px] " +
        " " +
